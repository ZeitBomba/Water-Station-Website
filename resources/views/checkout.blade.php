...
<body>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Check Out</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a href='index'>Home</a></h6>
            <h6 class="text-white m-0 px-3">/</h6>
            <h6 class="text-uppercase text-white m-0">Check Out</h6>
        </div>
    </div>
    <!-- Page Header Start -->
            ...
            <div class="col-lg-7">
				<div class="contact-form bg-light p-5">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <textarea class="form-control border-0" rows="4" placeholder="Your Address"></textarea>
                        </div>
						<div class="col-12">
                            <input type="text" name="landmarks" class="form-control border-0" placeholder="Landmarks" style="height: 55px;">
                        </div>
                        <div class="col-12">
							<center><a href="confirm" class="btn btn-primary py-md-3 px-md-5 mt-2" onclick="alert('Hello\ your order is confirmed please wait for the delivery')">Order</a></center>
                        </div>
                    </div>
                </div>
            </div>
