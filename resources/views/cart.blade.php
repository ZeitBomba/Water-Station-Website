...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
					...
					<a href= 'home2' class="nav-item nav-link bg-primary tesxt-white px-5 ms-3 d-none d-lg-block">Logout <i class="bi bi-box-arrow-right"></i></a>
                </div>
            </div>
        </nav>
    </div>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Shopping Cart</h1>
    ...
    <!-- Product START -->
      <div class="container-fluid py-0 px-5">
        <div class="text-center mx-auto mb-5" style="max-width: 700px;">
            <h1 class="display-5 text-uppercase mb-4">The <span class="text-primary">Best Quality</span> you and your family deserve</h1>
        </div>
        ...
        <div class="row g-5">
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="row g-0">
					...
					<span class="shop-item-title">Watter Bottle</span>
					   <center><span class="shop-item-price">350.00</span></center>
                        <div class="position-relative h-100">
                            <img class="shop-item-image"  style="object-fit: cover;" src="img/wbottle.jpg">
							<div class="card-footer d-flex justify-content-between bg-light border">
                                <button class="btn btn-primary w-100 py-4.5 shop-item-button"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</button>
							</div>
						</div>
					</div>
                </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="row g-0">
					...
					<span class="shop-item-title">Round Gallon</span>
					   <span class="shop-item-price">350.00</span>
                        <div class="position-relative h-100">
                            <img class="shop-item-image" class="position-absolute w-100 h-100" style="object-fit: cover;" src="img/rgallon.jpg">
                               <center><button class="btn-sm2 shop-item-button"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</button>
								</center>
						</div>
					</div>
                </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="row g-0">
                    <div class="col-10" style="min-height: 500px;">
                        <div class="position-relative h-100">
                            <a href ="order.wbottle.blade.php"><img class="position-absolute w-100 h-100" style="object-fit: contain; src="img/wbottle.jpg" "></a>
                       
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                                <a href='login' class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-bag text-primary mr-1"></i>Buy Now</a>
                                <a href='login' class="btn btn-sm text-dark p-0 shop-item-button "><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
